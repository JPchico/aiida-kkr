...
def create_bcc_fe(a_lat=lambda: orm.Float(2.87)) -> orm.StructureData:
    """
    Function to generate a bcc Fe structure
    ...
    structure = orm.StructureData(
        cell=[[-alat, alat, alat], [alat, -alat, alat], [alat, alat, -alat]]
    )
...
def main():
    ...
    bcc_structure = create_bcc_fe(a_lat=orm.Float(2.87))
    ...
    label = "JM-KKR_host_bcc_Fe"
    # Provide a more lengthy description of the actual calculation
    description = "Test BCC Fe SCF calculation with the JM-KKR host code"
    ...
    builder.structure = bcc_structure
