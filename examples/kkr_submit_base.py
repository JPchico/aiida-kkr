...
from aiida_kkr.workflows.base_kkr import BaseKKRWorkchain
...
def main():
    ...
    parent_folder = orm.load_node(32133)

    # Populate the inputs of the kkrhost code
    builder = BaseKKRWorkchain.get_builder()
    builder.code = kkr_code
    builder.options = orm.Dict(dict=options)
    builder.parameters = orm.Dict(dict=kkr_calculation_parameters)
